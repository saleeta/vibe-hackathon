/**
 * Fixed-size circular buffer used for temporal history (the camera sampler's
 * frame cadence bookkeeping and the eating-event detector's state-sequence
 * memory). Generic so it can hold
