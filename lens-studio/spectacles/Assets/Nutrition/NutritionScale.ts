/**
 * Lens-side port of nutrition-service's scaling math (B3 continued) — see
 * NutritionLookup.ts's header comment for why this copy exists alongside
 * the original `nutrition-service/src/scale.ts`.
 */
